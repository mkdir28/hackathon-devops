...
The repository is split into the **application** (`app/`) and the **platform / GitOps** deployment assets that make it a DevOps/SRE sandbox. The tree below highlights the directories.
...
[Platform Layer]                platform/                         Docker + Kubernetes (k3d) + GitOps (FluxCD)
